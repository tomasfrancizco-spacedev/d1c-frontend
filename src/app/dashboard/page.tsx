...
import { fetchTokenBalance, formatBalance, fetchUserContributions, calculateTotalContribution, fetchTradingVolume, getTradingVolumeAmount, fetchLeaderboard } from "@/lib/api";
import { D1CBalanceResponse, UserContribution, TradingVolumeData, LeaderboardEntry } from "@/types/api";
...
export default function Dashboard() {
  ...
  // Fetch leaderboard on component mount (not dependent on wallet)
  useEffect(() => {
        ...
        <main className="container mx-auto px-6 py-8 text-[#E6F0F0]">
          ...
          <div className="max-w-6xl mx-auto mt-16">
            <div className="flex items-center justify-center gap-3 mb-12">
              <h2 className="text-3xl font-bold text-[#E6F0F0] text-center drop-shadow-md">
              ...
              {leaderboardError ? (
                ...
                <>
                  ...
                  <div className="space-y-4 max-h-[600px] overflow-y-scroll scrollbar-custom p-2">
                    {leaderboardData.slice(0, 20).map((contributor) => (
            ...
            <div className="hidden md:block">
              {leaderboardError ? (
                ...
                <>
                  ...
                  <div className="grid grid-cols-2 gap-2 max-h-[600px] overflow-y-scroll scrollbar-custom">
