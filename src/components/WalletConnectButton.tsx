    ...
    return (
      <div className="flex items-center space-x-3">
        ...
        <button
          ...
          className="bg-[#15C0B9] hover:bg-[#13A8A1] text-white font-bold py-3 px-6 rounded-xl shadow-lg transform transition duration-200 hover:scale-105 flex items-center space-x-3"
        >
